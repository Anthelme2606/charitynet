...
const users = [
    { donateur: 'user1@example.com', country: 'France', beneficiaire: "beneficiaire1@example.com", montant: 500000 },
    { donateur: 'user2@example.com', country: 'France', beneficiaire: "beneficiaire2@example.com", montant: 500000 },
    { donateur: 'user3@example.com', country: 'Togo', beneficiaire: "beneficiaire3@example.com", montant: 500000 },
    { donateur: 'user4@example.com', country: 'Russie', beneficiaire: "beneficiaire4@example.com", montant: 500000 },
];

const DonManager = () => {
<<<<<<< HEAD:client/src/components/don-manager.js
...
=======
    ...
    const handleView = (user) => {
        ...
        setOpenDetail(true);
>>>>>>> origin/anthelme-feature:src/components/don-manager.js
    };
