  ...
  if (user?.isAuth) {
    switch (user?.auth?.userType) {
      ...
      case "Donor":
        links.push(
          { name: "Tableau de bord", link: ROUTES.DASHBOARD },
          { name: "Faire un don", link: ROUTES.MADEDONATION },
          { name: "Historique des dons", link: ROUTES.HISTORY },
          { name: "Profil", link: ROUTES.PROFIL },
          { name: "Notifications", link: ROUTES.NOTIFICATION },
